...
class SoftmaxModel(Model):
    ...
    def add_placeholders(self):
        ...
        """
        ### YOUR CODE HERE
        self.inputs_placeholder=tf.placeholder(tf.float32, shape=[self.config.batch_size, 
    ...
    def create_feed_dict(self, inputs_batch, labels_batch=None):
        ...
        feed_dict={self.inputs_placeholder: inputs_batch,
                  slef.labels_placeholder:labels_batch}
        ### END YOUR CODE
        return feed_dict
    ...
    def add_prediction_op(self):
        ...
        """
        ### YOUR CODE HERE
        self.w= tf.Variable(tf.random_uniform([self.config.n_features,self.config.n_classes],-1.0, 1.0,tf.float32))
                            
        self.bias=tf.Variable(tf.random_uniform([self.config.batch_size,1],-1.0,1.0,tf.float32))
                            
        op_temp=tf.matmul(self.inputs_placeholder,self.w)
        pred=softmax (tf.add(op_temp,self.bias))
    ...
    def add_loss_op(self, pred):
        ...
        """
        ### YOUR CODE HERE
        loss= cross_entropy_loss(self.labels_placeholder,prep)
        ### END YOUR CODE
        return loss
    ...
    def add_training_op(self, loss):
        ...
        """
        ### YOUR CODE HERE
        train_op=tf.train.GradientDescentOptimizer(0.1).minize(loss)
